...
import Binary_tree.BinaryTree.heapmover;
...
class BinaryTree
{
   ...
   private void leftView(Node root2) {
		// TODO Auto-generated method stub
	   heapmover d=new heapmover();
		leftView(root2,0,d);
	}

private void leftView(Node root,int curr,heapmover d) {
	   ...
	   //left recurrsive call
	   leftView(root.left,curr+1,d);
	   //right recurssive call
	   leftView(root.right,curr+1,d);
